...
- Can attach to zonal and regional resources, e.g.:
	- [Compute Engine VMs](Compute%20Engine.md)
	- [Network Load Balancers](Google%20Cloud%20Load%20Balancing.md)
- Supports IPv4
...
- Can attach to global resources only, e.g.:
	- [Global Load Balancers](Google%20Cloud%20Load%20Balancing.md) (HTTP(S), SSL, TCP proxies)
