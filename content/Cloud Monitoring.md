...
- Track [SLOs and SLAs](SLIs,%20SLOs%20and%20SLAs.md)
...
- Required for monitoring of [Compute Engine](Compute%20Engine.md) and AWS EC2 instances—most monitoring is baked into the Google Cloud services
...
- Export to [BigQuery](BigQuery.md) or external tools via Service Account authentication, e.g. Grafana
...
- Alerts—email, SMS, Slack, PagerDuty, [Pub/Sub](Pub%20Sub.md)
