...
- [Vertex AI](moc/Vertex%20AI.md) offers a flexible platform for deploying GenAI models
...
- Choose the right model for the job
	...
	- Using [Gemini](Gemini.md) for everything will be more expensive than PaLM Bison if not using multi-model