...
- Move data between clouds
	- Same storage architecture across [AWS](moc/AWS.md), [Azure](moc/Azure.md), and [Google Cloud](moc/Google%20Cloud.md)
- Software-only appliance
	- Runs [ONTAP](NetApp%20ONTAP.md) data management software on cloud
...
- Google Cloud:
	- [Persistent Disks](Compute%20Engine%20Persistent%20Disks.md)—user data
	- [Cloud Storage](Cloud%20Storage.md)—cold tier
...
- Ransomware protection
	- Readonly snapshots
	- [BlueXP](NetApp%20BlueXP.md) detects volumes not protected by snapshot policy