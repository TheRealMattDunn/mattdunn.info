...
## [Google Distributed Cloud Edge](Google%20Distributed%20Cloud%20Edge.md)
...
- Telco
	- Sensitive data
	- PiBs of data—want to keep in [BigQuery](BigQuery.md) for [Machine Learning](Machine%20Learning.md)
- Healthcare
