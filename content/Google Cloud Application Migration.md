...
- Requires most time/skill investment
	- Doesn't work for COTS (unless already [cloud native](The%20Path%20to%20Cloud%20Native.md))

### Strangler Pattern

- Lift and shift monolith, then break apart into [microservices](Microservices.md) over time

## Migrate for Compute Engine

- Migrate VMs to [Compute Engine](Compute%20Engine.md)
- Lift and shift
