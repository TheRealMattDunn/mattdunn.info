...
- Provision [Control Tower](moc/AWS%20Control%20Tower.md) accounts via [Terraform](moc/Terraform.md)
- Compatible with [Terraform Cloud](Terraform%20Cloud.md), Enterprise, and open source
- GitOps model
...
- AFT feature options—optional features, e.g.
	...
	- Deletion of default [VPCs](AWS%20VPCs.md) for all regions
- AFT customizations—customize accounts with public/private modules, e.g.
	- Additional [Controls](AWS%20Control%20Tower%20Controls.md)
	- Default firewalls
