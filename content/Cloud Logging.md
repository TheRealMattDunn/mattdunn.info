...
- What/what did what
- Admin activity logs
	- User initiated resource configuration e.g. [Compute Engine](Compute%20Engine.md) instance created by user
	- Always enabled
- System events
...
- Data access
	...
	- Manually enabled (except for [BigQuery](BigQuery.md))
...
- [Cloud Monitoring](Cloud%20Monitoring.md) metrics based on log entries
