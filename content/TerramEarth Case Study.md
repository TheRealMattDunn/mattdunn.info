...
- **Telemetry** from vehicles:
	- Small subset collected in **real-time** for fleet management
		- *Steaming via: [Cloud IoT Core](Cloud%20IoT%20Core.md), [Pub/Sub](Pub%20Sub.md)/[Dataflow](Dataflow.md), [BigQuery](BigQuery.md)/[Cloud Bigtable](Cloud%20Bigtable.md)*
	- Remainder uploaded as compressed **batch** files daily upon return to base: **200 to 500 MB/day = 1 PB/day total**
		- *Batch—[Cloud Storage](Cloud%20Storage.md), BigQuery*
...
- **Web frontend** for dealers and customers:
	...
	- Stock management
	- Analytics
		- *[App Engine](App%20Engine.md) or [Cloud Run](Cloud%20Run.md)*

## Business Requirements

- **Predict** vehicle malfunction to ship parts to dealerships for just-in-time repair
	- *[BigQuery](BigQuery.md) ML (SQL)*
	- *[AutoML](AutoML.md) Tables (business users)*
	- *[Vertex AI](moc/Vertex%20AI.md) (data scientists)*
- **Decrease** cloud ops costs
- Adjust to **seasonality**
	- *[Compute Autoscaling](Google%20Cloud%20Compute%20Autoscaling.md)*
...
- **Increase speed/reliability** of dev workflow
	- *[SRE](moc/Site%20Reliability%20Engineering%20(SRE).md)*
	- *CI/CD*
- **Remote** developers
	- Productivity
		- *Cloud Code*
...
- **Container**-based apps
	- *Cloud Run / [GKE](Kubernetes%20Engine%20(GKE).md)*
...
- [cloud native](The%20Path%20to%20Cloud%20Native.md) solutions for **keys/secret management**
