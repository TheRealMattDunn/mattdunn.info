...
- Transform VM-based workloads to containers running in [Kubernetes Engine](Kubernetes%20Engine%20(GKE).md), optionally on [GKE Enterprise](GKE%20Enterprise.md)
...
- Usually one process per pod in [Kubernetes](moc/Kubernetes.md)
...
- Use [ConfigMaps](ConfigMap.md) for service discovery
