...
- Automation bias
	...
	- e.g. Favouring model when humans perform with better [precision and recall](Precision%20and%20Recall.md)
...
- Use [Confusion Matrix](Confusion%20Matrix.md) on subgroups (classification problems only)
- Concentrate on false negative and false positive rates to see how adversely a subgroup is performing
- Calculate e.g. [Precision and Recall](Precision%20and%20Recall.md) for subgroups
