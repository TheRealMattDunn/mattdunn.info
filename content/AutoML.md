...
- Problem statement: training and deploying [ML](Machine%20Learning.md) models is time-consuming
- No-code solution
...
- Upload data from [Cloud Storage](Cloud%20Storage.md), [BigQuery](BigQuery.md) or local storage
