...
- Managed [Kubernetes](moc/Kubernetes.md) clusters
- Two modes:
	- Standard—total control
	- Autopilot—fully managed
- Auto-repair and upgrade
- [Autoscaling](GKE%20Cluster%20Autoscaling.md)
- Containerise legacy apps and migrate using [Migrate for Anthos and GKE](Migrate%20for%20Anthos%20and%20GKE.md)
- [GKE Multi-Tenancy](GKE%20Multi-Tenancy.md)
...
- Routing options:
	...
	- VPC-native
		...
		- [Pods](Pod.md) routable within cluster's VPC, and other networks connected via VPC peering
...
- Consistent user experience—GKE and [GKE Enterprise](GKE%20Enterprise.md)
- Real-time visibility of network activity
- Simpler architecture
- Based on eBPF and [Cilium](Cilium.md)—process network packets in-kernel
...
- Integrated with [Cloud Monitoring](Cloud%20Monitoring.md) and [Cloud Logging](Cloud%20Logging.md)
- Metrics:
...
- Combine with Autopilot—priced on [Pod](Pod.md) resource requests
...
- Metrics exposed in [Cloud Monitoring](Cloud%20Monitoring.md)—used to create custom reports, dashboards, alerts etc.
...
- [Google Cloud Decision Trees](moc/Google%20Cloud%20Decision%20Trees.md)
