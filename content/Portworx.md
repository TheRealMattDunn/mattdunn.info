...
- Containers in [Kubernetes](moc/Kubernetes.md) require:
...
- Backups, e.g. into [AWS](moc/AWS.md) S3
- Disaster recovery
...
- Options: [DaemonSet](DaemonSet.md) or [Operator](Kubernetes%20Operator%20Pattern.md)
...
- Create Kubernetes StorageClass object, and specify in [StatefulSet](StatefulSet.md) or PersistentVolume spec:
...
- Backup rules—select [Pods](Pod.md) via labels
