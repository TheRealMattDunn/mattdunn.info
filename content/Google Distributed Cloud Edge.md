...
- Run [Kubernetes](moc/Kubernetes.md) clusters on-prem on dedicated hardware provided and maintained by Google
	- Google engineers require physical access
- Deploy workloads like in [GKE](Kubernetes%20Engine%20(GKE).md)
- Provision new clusters in Cloud Console, CLI and API—similar to GKE
- Clusters can access [VPC](Google%20Cloud%20VPCs.md) via [Cloud VPN](Cloud%20VPN.md)
...
- [Anthos Service Mesh](GKE%20Enterprise.md) and Anthos Config Management not supported
...
- No [SLA](SLIs,%20SLOs%20and%20SLAs.md)—only SLO
