...
1. Upload data
	...
	- Label data—manually, or pay for Google to do this via the [Vertex AI](moc/Vertex%20AI.md) console
	- Upload—local, [BigQuery](BigQuery.md) or [Cloud Storage](Cloud%20Storage.md)
2. Feature engineers
	- Data prep before training—time-consuming and tedious
	- Vertex AI Feature Store
		- Organize, store and server [ML](Machine%20Learning.md) features
...
- [Confusion Matrix](Confusion%20Matrix.md)
	- [Precision and Recall](Precision%20and%20Recall.md)
- Feature importance
...
- Offline prediction—deploy outside of [Google Cloud](moc/Google%20Cloud.md)
