...
- Use cases:
	...
	- Extend Google Cloud products, e.g.
		- [BigQuery](BigQuery.md) remote functions—any supported language
		- [Cloud Storage](Cloud%20Storage.md)
		- [Cloud Firestore](Cloud%20Firestore.md)
...
- Built on [Cloud Run](Cloud%20Run.md)
...
- Function runs with own [Service Account](Cloud%20IAM.md)
...
- Ingress
	...
	- Can configure to allow only from [VPCs](Google%20Cloud%20VPCs.md) within project or VPC Service Control perimeter
- Egress
