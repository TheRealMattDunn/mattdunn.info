...
- Grant on-premises/multi-cloud workloads access to [Google Cloud](moc/Google%20Cloud.md) resources
	- Grant external resources [Cloud IAM](Cloud%20IAM.md) roles
...
- Workload Identity Pool Providers
	...
	- Options (any provider that supports OpenID Connect (OIDC)):
		- [AWS](moc/AWS.md)
		- [Azure](moc/Azure.md) Active Directory
		- On-prem Active Directory Federation Services (ADFS)
		- Okta
		- [Kubernetes](moc/Kubernetes.md) clusters
...
- If workload doesn't have public OIDC endpoint
	...
	- e.g. [Terraform](moc/Terraform.md) or GitHub Enterprise hosted in own environment
