...
- Working with [Terraform](moc/Terraform.md) as a team:
	- Shared [state](Terraform%20State.md)—minimum requirement
...
- Allows for [Sentinel](Sentinel.md) policy enforcement
...
- Share [providers](Terraform%20Providers.md) and [modules](Terraform%20Modules.md) across organization
- Versioning
- Searchable
