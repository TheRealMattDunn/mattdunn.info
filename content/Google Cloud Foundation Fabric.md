...
- End-to-end [Terraform](moc/Terraform.md) blueprints and [Modules](Terraform%20Modules.md)
- Organization-wide landing zone blueprint—Fabric FAST
- Reference blueprints—network patterns, product features
- Set of lean modules
- Makes extensive use of [Terraform Resource Factories](Terraform%20Resource%20Factories.md)
...
- Solution:
	...
	- Mini-landing zone
		...
		- [Audit log sink](Cloud%20Logging.md)
		- [CMEK](Google%20Cloud%20CMEK%20and%20CSEK.md)
