...
| Accelerator optimized (A2)     | Highest performance GPUs for [ML](Machine%20Learning.md), HPC and parallel computing | 
| Scale-out optimized (Tau T2D)  | Horizontally scalable [cloud native](The%20Path%20to%20Cloud%20Native.md) workloads  |
...
- Created from: source disks, images, snapshots, images stored in [Cloud Storage](Cloud%20Storage.md)
- Used to create VM instances
- Virtual disk import tool: import boot disk images from existing systems
- Stored in [Cloud Storage](Cloud%20Storage.md)—zonal or regional
