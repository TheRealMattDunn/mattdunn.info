...
- Best practices for [GKE](Kubernetes%20Engine%20(GKE).md) multi-tenancy with enterprise organisations
- Assume teams deploy workloads through [Kubernetes](moc/Kubernetes.md) API without platform team's input
...
- [Private clusters](Kubernetes%20Engine%20(GKE).md#clusters)
	- Disable access to nodes and manage control plane access
- Regional clusters—control plane and nodes
- Utilise [autoscaling](GKE%20Cluster%20Autoscaling.md)
	- [HorizontalPodAutoscaler (HPA)](HorizontalPodAutoscaler.md)
	- VerticalPodAutoscaler available—can compete with HPA, so start with HPA
- Schedule maintenance windows
- Set up shared [Ingress](Ingress.md)/[load balancer](Google%20Cloud%20Load%20Balancing.md)
...
- Policy-based admission controls
	...
	- Options:
		- Gatekeeper OPA—requires [GKE Enterprise](GKE%20Enterprise.md)
		- PodSecurity admission controller
- [Workload Identity Federation](Workload%20Identity%20Federation.md) for GKE
	- Access to GCP services
	- Map Kubernetes service accounts names to virtual [Google Cloud](moc/Google%20Cloud.md) service account handles—assign IAM roles
- Authorized Networks
...
- GKE Cost Allocation
	...
	- Not supported by [Autopilot](Kubernetes%20Engine%20(GKE).md#autopilot)
