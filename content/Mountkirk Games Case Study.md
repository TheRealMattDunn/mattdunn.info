...
- Planned architecture:
	- Plan to deploy backend to **[GKE](Kubernetes%20Engine%20(GKE).md)**
		- *Multiple regional clusters*
		- *[GKE Enterprise](GKE%20Enterprise.md) for common config management and service mesh capabilities*
		- *[Multi Cluster Ingress](Multi%20Cluster%20Ingress.md)*
	- Wish to **scale** rapidly based on **demand**
	- Usage of **[global load balancers](Google%20Cloud%20Load%20Balancing.md)** to route players to the closest regional arena
	- Usage of a **multi-region [Cloud Spanner](Cloud%20Spanner.md)** cluster to keep global leaderboard in sync
		- *Streaming data*

## Existing Environment

- Recently migrated to Google Cloud
- Five games migrated via **lift-and-shift to [Compute Engine](Compute%20Engine.md) VMs**
...
- Minimize **latency**
	...
	- *Cloud CDN*
	- *Caching with [Memorystore](Memorystore.md)*
- Optimize for **dynamic scaling**
	- *GKE node and pod horizontal autoscaling*
	- *Spanner doesn't autoscale—need to implement custom solution, e.g.*
		- *Cloud monitoring (CPU), [Pub/Sub](Pub%20Sub.md), [Cloud Functions](Cloud%20Functions.md)*
- Use **managed services** and pool resources
	...
	- *Pooled resources: shared project for management and analytics*
		- *Log buckets, [BigQuery](BigQuery.md), Anthos*
- Minimize costs

## Technical Requirements

- **Dynamically** scale based on **game activity**
	- *Horizontal pod autoscaler and [node autoscaling](GKE%20Cluster%20Autoscaling.md)*
...
- Game activity **logs** stored in **structured files** for **analysis**
	...
	- *Store logs in [Cloud Storage](Cloud%20Storage.md)—load as BigQuery external table*
...
- Wish to analyse player behaviour and **game telemetry**
	- *[Cloud Bigtable](Cloud%20Bigtable.md) for telemetry storage*
	- *BigQuery, [BigQuery ML](BigQuery%20ML.md)*
- Use **[cloud native](The%20Path%20to%20Cloud%20Native.md)** design principles
