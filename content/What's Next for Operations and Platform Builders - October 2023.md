...
- [Vertex AI](moc/Vertex%20AI.md)—foundation model consumers
- AI IaaS—foundation model providers
	- [Compute Engine](Compute%20Engine.md), [Kubernetes Engine (GKE)](Kubernetes%20Engine%20(GKE).md) etc.
...
- Choices—right tool for job
	- [Cloud Run](Cloud%20Run.md)
		...
		- No infrastructure
		- Rapid autoscaling
		- [Sidecars support](Cloud%20Run%20Sidecars.md)
	- [Kubernetes Engine (GKE)](Kubernetes%20Engine%20(GKE).md)
...
- 200+ [Compute Engine](Compute%20Engine.md) instances created per hour
