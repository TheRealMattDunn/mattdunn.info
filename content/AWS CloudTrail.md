...
- Organization trails
	- Log all events for [Organization](AWS%20Organization%20Hierarchy.md)
	- Create in management account
	- Member accounts have no access by default
	- [Control Tower](moc/AWS%20Control%20Tower.md) sets up organization level trail by default
