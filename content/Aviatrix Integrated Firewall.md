...
- No requirement for NGFWs—use [Aviatrix Transit FireNet](Aviatrix%20Transit%20FireNet.md) otherwise
- Placed in transit layer
- Rules managed by [Aviatrix Controller](Aviatrix%20Controller.md)
