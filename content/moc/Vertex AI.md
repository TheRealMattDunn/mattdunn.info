...
- [Vertex AI ML Workflow](Vertex%20AI%20ML%20Workflow.md)
...
- [Vertex AI Workbench](Vertex%20AI%20Workbench.md)
	- Jupyter Notebook development environment
	- Can process data in [Dataproc](Dataproc.md), train models etc.
...
- [Google Cloud for GenAI](Google%20Cloud%20for%20GenAI.md)
- [Gemini](Gemini.md)

## Tools

- Connected to [Cloud Logging](Cloud%20Logging.md) and [Cloud Monitoring](Cloud%20Monitoring.md)
- Client libraries—native libraries (Python, Node.js, Java), and API libraries for other languages
- REST API
- Deep Learning VM Images—[Compute Engine](Compute%20Engine.md) images with tools pre-installed e.g. TensorFlow, PyTorch
