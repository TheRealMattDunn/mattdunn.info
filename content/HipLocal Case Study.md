...
- Community application
	- **Communication** between people in **close proximity**
		- *Streaming data: [Cloud IoT Core](Cloud%20IoT%20Core.md), [Pub/Sub](Pub%20Sub.md)*
		- *Data synchronization: [Cloud Firestore](Cloud%20Firestore.md)*
...
- Ensure:
	...
	- Provide clear **uptime** data
		- [Cloud Monitoring](Cloud%20Monitoring.md)
...
- Mixture of **on-prem** and **Google Cloud infrastructure**
	- [Cloud VPN](Cloud%20VPN.md), [Cloud Interconnect](Cloud%20Interconnect.md)
- Team understands app, but **limited experience of globally scaled apps**
	- *Prefer managed solutions*
- **APIs** run on **[Compute Engine](Compute%20Engine.md)** instances
	- *Migrate to [Cloud Endpoints](Cloud%20Endpoints.md), [Google Cloud API Gateway](Google%20Cloud%20API%20Gateway.md) or Apigee*
- State stored in single **MySQL** instance in Google Cloud
	- *Migrate to [Cloud SQL](Cloud%20SQL.md) or [Cloud Spanner](Cloud%20Spanner.md)*
...
- **Deployments manual** by infrastructure engineers during quiet periods
	- *CI/CD: [Cloud Build](Cloud%20Build.md), [Spinnaker](Spinnaker.md)*
	- *Canary, blue/green deployments*
- Basic **SLIs**—uptime alerts fired when APIs unresponsive
	- *Improve with [Cloud Monitoring](Cloud%20Monitoring.md)*

## Business Requirements

- Expand to new locations—consistent experience
	- *[Global Load Balancing](Google%20Cloud%20Load%20Balancing.md)*
	- *Regional compute*
	- *[Cloud CDN](Cloud%20CDN.md)*
- Support **10x** as many concurrent users
	- *Autoscaling: MIGs*
- Collect **user metrics**—monetize product
	- *[BigQuery](BigQuery.md) or [Cloud Bigtable](Cloud%20Bigtable.md) for time-series data*
	- *[Cloud Logging](Cloud%20Logging.md), [Cloud Domains](Cloud%20Domains.md)*
- Ensure **regulatory compliance** (e.g. GDPR)
- **Reduce** infrastructure management **time** and **cost**
	- *IaC, e.g. [Terraform](moc/Terraform.md)*
...
- **Secure communications** between **on-prem** and **Google *Cloud***
	- *TLS, [Cloud VPN](Cloud%20VPN.md), [Cloud Interconnect](Cloud%20Interconnect.md)*
- Usage **metrics/monitoring**
	- *[BigQuery](BigQuery.md)*
- APIs—**authentication**/**authorization**
	- *OpenAPI, [Cloud Endpoints](Cloud%20Endpoints.md)/[Google Cloud API Gateway](Google%20Cloud%20API%20Gateway.md)/Apigee*
	- *Internal apps: [Identity Aware Proxy](Identity%20Aware%20Proxy.md)*
...
- **Logging**/performance metrics—actionable information, **debugging** and **alerts**
	- *[Cloud Logging](Cloud%20Logging.md), [Cloud Monitoring](Cloud%20Monitoring.md), [Cloud Debugger](Cloud%20Debugger.md)*
- **Scale** to meet user demands
	- *MIGs, [Google Cloud Load Balancing](Google%20Cloud%20Load%20Balancing.md)*
	- *Migrate to serverless: [App Engine](App%20Engine.md), [Cloud Run](Cloud%20Run.md), [Cloud Functions](Cloud%20Functions.md)*
