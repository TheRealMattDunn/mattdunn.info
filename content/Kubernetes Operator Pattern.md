...
- Method for packaging, deploying and managing [Kubernetes](moc/Kubernetes.md) applications
...
- Operators follow Kubernetes principles—e.g. control loop ([Controllers](Kubernetes%20Controllers.md))
