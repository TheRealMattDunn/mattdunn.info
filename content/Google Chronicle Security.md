...
- Specialized layer on top of core [Google](moc/Google%20Cloud.md) infrastructure
...
- Third-party integrations
	- e.g. Office 365, [Azure](moc/Azure.md) AD
...
- Ingested by data forwarder (e.g. Chronicle Forwarder) or read from object storage—[Cloud Storage](Cloud%20Storage.md), S3
