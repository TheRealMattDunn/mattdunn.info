...
- Exposes the [Kubernetes](moc/Kubernetes.md) API—front end to control plane
- Scales horizontally

#### Kube-scheduler

- Responsible for assigning [Pods](Pod.md) to nodes
...
- Runs [Controller](Kubernetes%20Controllers.md) processes
- Examples:
	- Node controller—watches and responds to nodes going down
	- [Job](Job.md) controller—watches for Jobs and creates Pods to run those tasks
