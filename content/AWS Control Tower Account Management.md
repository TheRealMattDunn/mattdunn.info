...
- Four methods for account provisioning in [Control Tower](moc/AWS%20Control%20Tower.md):
...
- Steps:
	1. Initiate request e.g. Account Factory calls [Service Catalog](AWS%20Service%20Catalog.md)
	2. Service Catalog calls Control Tower
	3. Control Tower workflow—calls [AWS Organizations](AWS%20Organization%20Hierarchy.md) CreateAccount API
	4. Control Tower applies blueprints and [Controls](AWS%20Control%20Tower%20Controls.md)
