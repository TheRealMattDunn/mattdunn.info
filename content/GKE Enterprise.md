...
- [Kubernetes](moc/Kubernetes.md) on Google Cloud, AWS, Azure and on-prem (VMware and [bare metal](Anthos%20on%20Bare%20Metal.md))
	- Google managed control plane
- Supports:
	- [Kubernetes Engine clusters](Kubernetes%20Engine%20(GKE).md)
	- [Cloud Run](Cloud%20Run.md)
	- [Compute Engine](Compute%20Engine.md) VMs
- [Migrate for Anthos and GKE](Migrate%20for%20Anthos%20and%20GKE.md)—migrate legacy workloads to containers
- Anthos Config Management
	- Policy enforcement
	- Guardrails
	- Security in depth
- Anthos Service Mesh
	- Managed, observable, secure communications between [microservices](Microservices.md)
	- Istio
...
- [GKE](Kubernetes%20Engine%20(GKE).md)
- [Multi Cluster Ingress](Multi%20Cluster%20Ingress.md)
- [Migrate for Anthos and GKE](Migrate%20for%20Anthos%20and%20GKE.md)
