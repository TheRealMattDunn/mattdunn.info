...
- Automate CIS Benchmarking
	- kube-bench
	- [GKE Enterprise](GKE%20Enterprise.md) Config Management with CIS benchmark policies
- Google Groups for RBAC
- Run nodes with least privilege SA—avoid [Compute Engine](Compute%20Engine.md) default service account
...
- Use shielded [GKE](Kubernetes%20Engine%20(GKE).md) nodes—protects against node impersonation
...
- Ensure audit logging is enabled—export logs to [BigQuery](BigQuery.md)
