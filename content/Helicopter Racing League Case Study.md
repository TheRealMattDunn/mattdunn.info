...
- Increase use of **AI/[ML](Machine%20Learning.md)** services
...
- Race predictions via **TensorFlow** models running on **VMs**
	- *Lift/shift with Migrate for Compute Engine*
	- *[TPUs](Google%20Cloud%20TPUs.md)s—Tensor Processing Unit, built for TensorFlow*
...
- **Reduce latency** in emerging markets
	...
	- *Regional [Cloud Storage](Cloud%20Storage.md) buckets*
...
- Increase predictive capabilities (race results, mechanical failures, crowd sentiment)
	...
	- *Sentiment analysis:*
		...
		- *[AutoML](AutoML.md) Natural Language—custom categories*
		- *Vertex AI—Video Intelligence API*
- Increase **telemetry** and **insights**
	- *[Cloud IoT Core](Cloud%20IoT%20Core.md)*
	- *[Cloud Bigtable](Cloud%20Bigtable.md), [Dataflow](Dataflow.md), [BigQuery](BigQuery.md), Looker*
...
- Increase number of **concurrent viewers**
	- *Increase capacity*
	- *Dynamic horizontal scaling—[Autoscaling Groups](Google%20Cloud%20Compute%20Autoscaling.md)*
...
- New revenue streams e.g. merchandise
	- *Online store—SaaS*
	- *[Cloud Run](Cloud%20Run.md), [App Engine](App%20Engine.md), [Cloud Firestore](Cloud%20Firestore.md)*
