...
- Data processing
	- [Event Driven Architectures](Event%20Driven%20Architecture.md)
	- Scheduled scripts
...
- [Sidecar support](Cloud%20Run%20Sidecars.md)
...
- Ingress container must listen for request on 0.0.0.0:8080 (port configurable)
	- HTTPS, gRPC, [Pub/Sub](Pub%20Sub.md), Cloud Tasks, Cloud Scheduler
- Must be stateless
