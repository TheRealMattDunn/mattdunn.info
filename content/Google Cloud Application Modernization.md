...
- Containers—Google Cloud container-based cloud
	...
	- Can run containers on: [Cloud Run](Cloud%20Run.md), [Kubernetes Engine](Kubernetes%20Engine%20(GKE).md), [Compute Engine](Compute%20Engine.md), [Cloud Functions](Cloud%20Functions.md) and [App Engine](App%20Engine.md)

### Take a Holistic Platform View

- Make use of other platform components, e.g. [Pub/Sub](Pub%20Sub.md)
...
- Utilize Kubernetes Resource Model (KRM) to provision infrastructure
	- Manage services as through they are [Kubernetes](moc/Kubernetes.md) resources, e.g. [Cloud Spanner](Cloud%20Spanner.md) with ~10 lines of YAML
