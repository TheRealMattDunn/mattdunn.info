...
- Google [report](https://services.google.com/fh/files/misc/state_of_kubernetes_cost_optimization.pdf) into how Elite performers optimize their [Kubernetes](moc/Kubernetes.md) clusters
...
- As a minimum: set resource `requests`
	- Set for workloads that actually need the reliability that [burstable/guaranteed QOS brings](Predictable%20Demands%20Pattern.md)
	- Some workloads are fine with best-effort
	- Controls many critical aspects:
		- Scheduling
		- Bin packing
		- [HorizontalPodAutoscaler](HorizontalPodAutoscaler.md)
		- [Cluster Autoscaling](GKE%20Cluster%20Autoscaling.md)
		- Cost allocation
		- Reliability
		- Performance
...
- Use [GKE](Kubernetes%20Engine%20(GKE).md) Cost Optimization tab
