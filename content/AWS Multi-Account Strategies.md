...
- [Control Tower](moc/AWS%20Control%20Tower.md)—orchestration framework for dealing with large numbers of accounts
...
- No connection to DC
- Manages [OUs](AWS%20Organization%20Hierarchy.md) and [SCPs](AWS%20Service%20Control%20Policies%20(SCPs).md)
