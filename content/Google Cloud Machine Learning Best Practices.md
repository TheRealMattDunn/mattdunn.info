...
- Store tabular data in [BigQuery](BigQuery.md)
- Store unstructured data in [Cloud Storage](Cloud%20Storage.md)
...
- When training a new model:
	1. Search [Vertex AI](moc/Vertex%20AI.md) Feature Store for existing features meeting requirements
...
- Process tabular data with [BigQuery](BigQuery.md)
- Process unstructured data with:
	- [Dataflow](Dataflow.md)—General use cases, Apache Bean
	- [Dataproc](Dataproc.md)—Apache Hadoop or Spark use cases
...
- Small datasets—Train in [Jupyter notebooks](Vertex%20AI%20Workbench.md)
